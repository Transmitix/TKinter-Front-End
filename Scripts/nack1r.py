...
import nack1r_epy_block_0 as epy_block_0  # embedded python block
import sip
import threading



class nack1r(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "nack1r")
        ...
        self.soapy_bladerf_source_0.set_sample_rate(0, 1200000)
        ...
        self.blocks_throttle2_0_0_0 = blocks.throttle( gr.sizeof_char*1, spr, True, 0 if "auto" == "auto" else max( int(float(0.1) * spr) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(1, 8, "", False, gr.GR_MSB_FIRST)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/thevinduk/Repositories/TKinter-Front-End/received_files/Output.txt', False)
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_throttle2_0_0_0, 0))
        self.connect((self.blocks_throttle2_0_0_0, 0), (self.blocks_file_sink_0, 0))
    ...
    def set_spr(self, spr):
        self.spr = spr
        self.blocks_throttle2_0_0_0.set_sample_rate(self.spr)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 187500, 0.2, 64))
...
def main(top_block_cls=nack1r, options=None):
    if options is None:
